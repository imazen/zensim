...
> [`docs/WAVE_PLAYBOOK.md`](../WAVE_PLAYBOOK.md) for the current workflow and
> [`docs/DATA_SPLITS.md`](../DATA_SPLITS.md) / [`docs/DATASET_HISTORY.md`](../DATASET_HISTORY.md)
...
picking. See [`docs/CODEC_TARGET_METRIC.md`](../CODEC_TARGET_METRIC.md)
...
- [docs/](..) — paper notes, literature reviews, long-form design docs
