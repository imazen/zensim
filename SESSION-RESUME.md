...
| Does native attribution already exist? | Yes: JXL fused/binned/stale H3, a recovered JPEG `jj` experiment, WebP segments and the later AVIF CQ/H3 experiment. [Fleet/source/chronology audit](benchmarks/diffmap_reuse_audit_2026-09-08.md): reuse them. The remaining serving gap is binding complete `BakeScorer` composition and declared extraction to the existing attribution owner. Existing attribution tests: 26 passed, 2 ignored. |
