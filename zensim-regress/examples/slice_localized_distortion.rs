...
fn main() {
    ...
    type SummaryRow = (String, u8, usize, Option<usize>, Option<usize>, usize);
    ...
    for src_path in &candidates {
        ...
        let target_window_indices = [n_windows / 4, n_windows / 2, 3 * n_windows / 4];
        ...
        for &target_w in &target_window_indices {
            ...
            for &step in distortion_steps {
                ...
                for (y0, win_h, pre) in &window_refs {
                    ...
                    let result = z
                        .compute_with_ref_into(pre, &dist_slice, &mut scratch)
                        .unwrap();
