...
static PROFILE_PREVIEW_V0_2: ProfileParams = ProfileParams {
    weights: &WEIGHTS_PREVIEW_V0_2_PRUNED,
    blur_radius: 5,
    blur_passes: 1,
    num_scales: 4,
    score_mapping_a: 18.0,
...
// Auto-generated by tools/prune_v0_2.py: V0_2 with SSIM weights of low-mass cells
// (scale 0 X, scale 0 B, scale 1 X, scale 2 X) zeroed. Eligible-but-not-flipped cells:
// 1 B (mass 1.95, max abs 1.x), 2 B (mass 1.79, max abs 1.x).
// SROCC validated: 0.9959/0.8427/0.8191/0.8680 vs unpruned 0.9959/0.8427/0.8192/0.8676.
#[allow(clippy::excessive_precision)]
pub static WEIGHTS_PREVIEW_V0_2_PRUNED: [f64; 228] = [
    // --- Basic features (13/ch × 3ch × 4 scales = 156) ---
    0.0000000000,
    0.0000000000,
    0.0000000000,
    ...
    0.0000000000,
    0.0000000000,
    0.0000000000,  // Scale 0 Channel X (peak)
    0.4482423487,
    1.7175745862,
    0.0000000000,
    0.0000000000,
    0.0000000000,
    8.3046937974,  // Scale 0 Channel Y (peak)
    0.0000000000,
    0.0000000000,
    0.0000000000,
    0.0000000000,
    0.0000000000,
    0.0000000000,  // Scale 0 Channel B (peak)
    0.0000000000,
    0.0000000000,
    0.0000000000,
    0.0000000000,
    0.0000000000,
    0.0000000000,  // Scale 1 Channel X (peak)
    0.0000000000,
    0.0000000000,
    0.0000000000,
    0.0000000000,
    0.5506673335,
    0.0000000000,  // Scale 1 Channel Y (peak)
    0.0000000000,
    0.0000000000,
    0.0000000000,
    0.0000000000,
    5.5320293663,
    0.0000000000,  // Scale 1 Channel B (peak)
    0.0000000000,
    8.0037734436,
    0.0000000000,
    0.0000000000,
    1.0761444814,
    0.0000000000,  // Scale 2 Channel X (peak)
    1.5371198008,
    0.0000000000,
    0.0000000000,
    2.8277784618,
    0.0000000000,
    0.0000000000,  // Scale 2 Channel Y (peak)
    1.6209056242,
    0.0000000000,
    0.0000000000,
    0.0000000000,
    0.9606478120,
    0.0000000000,  // Scale 2 Channel B (peak)
    13.6786977377,
    0.0000000000,
    0.0000000000,
    0.0000000000,
    1.7799580769,
    0.0000000000,  // Scale 3 Channel X (peak)
    1.6034688535,
    0.4040027990,
    13.5194607333,
    2.6215292388,
    0.0000000000,
    0.0000000000,  // Scale 3 Channel Y (peak)
    1.6611285265,
    6.9307627972,
    0.0000000000,
    0.7474376328,
    12.8104312758,
    0.0000000000,  // Scale 3 Channel B (peak)
];
