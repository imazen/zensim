#!/usr/bin/env bash
# SPH1 HF-preserving variant arm (registered in
# benchmarks/sdr_pure_retrain_wave_2026-08-28.md "HF-PRESERVING VARIANT ARM").
...
HB=${SPH1_HB:-$HOME/tmp/sph1/heartbeat}
mkdir -p "$(dirname "$HB")"
