...
"""
# ----------------------------------------------------------------------
# Historical context (2026-05-26 cleanup)
#
# This script was originally written for the V_06 "rebalance" experiment
# (commit af95701, 2026-05-05) which hypothesized that adding non-photo
# content classes would improve metric SROCC on screen/document/line-art.
# The V_06 + FiLM-gated training was later FALSIFIED (PR #31 closed
# 2026-05-18; CID22 +0.043 but KADID -0.115, TID -0.128, KonJND -0.396
# vs Balanced ship). See benchmarks/exp_v06_film_falsified_2026-05-18.md
# (if extant) or the master inventory at
# ~/work/zen/_ml-inventory-2026-05-20/00-MASTER-SYNTHESIS.md.
#
# The script itself is kept because its OUTPUT (gen-chart/doc/line/screen
# PNGs in /mnt/v/input/zensim/sources/) became permanent training input
# for the cvvdp_iwssim_LARGE corpus. Re-running it (with same seed
# 20260505) is the only way to regenerate that content.
#
# Companion training/eval scripts from the original v06_cclass/ dir are
# NOT retained — their stats are out of date and they depended on
# dataset_metric_baseline.rs which was deleted from main in commit
# 34f796f (2026-05-20 cleanup).
# ----------------------------------------------------------------------
