...
# restored families. Reports wall time, pairs/s, and the f0..f1501 bit identity between all three.
...
run candall "$ROOT/bin/extract_cand" --restore-cuts mapdev,z1max,gmsnative,dvifmgate
