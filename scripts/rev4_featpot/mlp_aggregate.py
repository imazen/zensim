"""Pool registered MLP outer-fold predictions and report all five seeds.
...
def main() -> None:
    ...
    args = ap.parse_args()
    base = ROOT / "fits" / f"POT_{args.set}_{args.arm}_mlp{args.hidden}"
    ...
    output = {"schema": "rev4-featpot-mlp-pooled-v1",
    ...
    dest = ROOT / "mlp_aggregate" / f"POT_{args.set}_{args.arm}_mlp{args.hidden}"
