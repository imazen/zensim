"""B=2,000 reference-clustered SROCC interval for one P2 MLP replicate.
...
def main() -> None:
    ...
    root = (ROOT / "p2/mlp" / f"POT_{args.set}_{args.arm}_mlp{args.hidden}"
            / f"{tag}_r{args.rep}")
    ...
    output = {"schema": "rev4-featpot-p2-mlp-replicate-ci-v1",
