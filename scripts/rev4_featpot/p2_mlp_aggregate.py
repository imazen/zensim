"""Pool registered P2 MLP outer-fold predictions and report all five seeds.
...
from p2_mlp import INIT_SEEDS, SAMPLE_SEEDS
...
def main() -> None:
    ...
    args = ap.parse_args()
    base = ROOT / "p2/mlp" / f"POT_{args.set}_{args.arm}_mlp{args.hidden}"
    ...
    output = {"schema": "rev4-featpot-p2-mlp-pooled-v1",
    ...
    dest = ROOT / "p2/mlp_aggregate" / f"POT_{args.set}_{args.arm}_mlp{args.hidden}"
