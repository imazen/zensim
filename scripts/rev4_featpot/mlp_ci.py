"""B=2,000 reference-clustered SROCC interval for one registered MLP replicate.
...
def main() -> None:
    ...
    root = (ROOT / "fits" / f"POT_{args.set}_{args.arm}_mlp{args.hidden}"
            / f"{tag}_r{args.rep}")
    ...
    output = {"schema": "rev4-featpot-mlp-replicate-ci-v1",
