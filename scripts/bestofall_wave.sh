...
cell() {
  ...
  # Explicit-ID conversion is now scoreable on the same identity-column tables
  # through BakeScorer. Keep packed bytes as this historical recipe's scored
  # artifact, and require the declared-ID conversion/parity gate to succeed.
  say "DENSIFY $name"
