#!/usr/bin/env python3
"""hdrgrid372 in-domain val read — mirror of `hdrp1_val_read.py` at the leg's
native 372 width: forward a bake over the hdrgrid372 val split, report
...
ap.add_argument("--parquet",
                default="/mnt/v/output/zensim/hdrgrid372-leg/hdrgrid372_v3mix_valdigits_2026-08-26.parquet")
a = ap.parse_args()
