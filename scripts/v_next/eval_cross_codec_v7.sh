...
python3 /home/lilith/work/zen/zensim--cross-codec-v7/scripts/v_next/eval_v7_pjnd_check.py "${V7_DIR}" || echo "v7 pjnd check failed"

echo
echo "=== Phase 5: multi-band cross-codec consistency check (V6 gate, all 6 bands) ==="
python3 /home/lilith/work/zen/zensim--cross-codec-v7/scripts/v_next/eval_v7_multi_band_check.py "${V7_DIR}" || echo "v7 multi-band check failed"
