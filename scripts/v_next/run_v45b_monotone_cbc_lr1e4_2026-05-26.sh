...
OUT="$OUTDIR/v45b_monotone_cbc_lr1e4_seed17_2026-05-26.bin"
LOG="$REPO/benchmarks/v45b_monotone_cbc_lr1e4_seed17_2026-05-26.log"
mkdir -p "$OUTDIR"
...
"$TRAIN" \
  ...
  --hidden 128 --n-hidden-layers 2 --per-sample-alpha-head --epochs 200 --lr 1e-4 --l2 0.0001 --seed 17 \
