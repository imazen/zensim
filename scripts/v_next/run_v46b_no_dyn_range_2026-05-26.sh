...
OUT="/mnt/v/output/zensim/bakes/v46b_no_dyn_range_seed17_2026-05-26.bin"
LOG="/home/lilith/work/zen/zensim/benchmarks/v46b_no_dyn_range_seed17_2026-05-26.log"
mkdir -p "$(dirname "$OUT")"
"$TRAIN" \
