...
| **R2 endpoint / bucket names** | 26 `.sh` + `zenmetrics/crates/vastai-fleet/src/worker/r2.rs`, `mod.rs`, `main.rs` | endpoint forked across shell + Rust; the Rust fleet crate has its own copy. |
