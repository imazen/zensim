...
| Correction: strict loss/gain orientation | **Pass:** 257 synthetic pixels with `m_d < m_r` feed all five constants and yield positive loss, bitwise zero gain. A textured-reference/uniform-destination pair yielded bitwise zero C8 gain in every dispatch permutation. The final monotone-ramp reference tier test is pending. | `/var/tmp/gmsbank/command_records/correction_orientation_{unit,tiers}.log` (SHA256 `721564ade1cc63c6e28cbecc5567523570a8ccaa07be605a4327120326285a88`, `56fbec73a456d6f43138151decd69f58322b80612b6ba9455292a1a7ebe949b5`) |
